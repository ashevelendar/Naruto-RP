...
* **Hard-Light Weapons**: Solid light constructs including blades, kunai, and shuriken.
...
* **Dynamic Expansion / Geometry**: A hard-light construct can change its shape and size after formation. Ashe has successfully created a narrow blade, inserted it into a wooden training post, then expanded the construct while partially embedded. Larger and more complex geometry requires more chakra and concentration. This has only been tested on inanimate material and has not been tested against a living opponent.
...
- Ashe trained with a Konoha swordsman and studied conventional sword footwork, recovery, body alignment, timing, and weapon commitment.
- She applied those fundamentals to hard-light sword use.
